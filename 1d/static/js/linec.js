...
let draw_line = function () {
    ...
    var layout = {
        // title: 'test',
        showlegend: true,
        margin: {t:0, l:20, b:110, r:20},
        sliders: sliders
        // margin: {t:100, l:0, b:0}
    };
    // dataline[0][0].visible = true;
    // dataline[0][1].visible = true;
    dataline[0].visible = true;
    dataline[1].visible = true;
    console.log(dataline);
    console.log(steps);
    Plotly.newPlot('linec', [dataline[0]], layout, config);
    for (let i=1; i<dataline.length; i++) {
        Plotly.addTraces('linec', dataline[i])
    };
