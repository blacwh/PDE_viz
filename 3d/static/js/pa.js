...
let new_data2 = [[null,null,null,null,null,null,null,null,null,null,null,null],
...
for (let i=1; i <= 10; i++) {
        ...
        new_data2[i-1][11] = loss[i-1];
        new_data2[i-1][12] = g1_data[i-1][2];
